...
import { FaGithub, FaExternalLinkAlt, FaFilter, FaCode, FaMobile, FaGlobe, FaDatabase } from 'react-icons/fa'
import './Projects.css'
...
const Projects: React.FC = () => {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      description: 'Aplicativo de gerenciamento de tarefas com drag & drop, notificações e sincronização em tempo real.',
    ...
    },
    {
      ...
      description: 'Aplicativo mobile para banco digital com autenticação biométrica e transferências PIX.',
    ...
    },
    {
      ...
      description: 'Site portfólio responsivo com animações e mini jogo interativo.',
    ...
    },
    {
      ...
      description: 'Serviço de API REST para gestão de usuários com autenticação JWT e documentação Swagger.',
